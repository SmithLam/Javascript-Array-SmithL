const inventors = [
  ...
  let firstInitial = FirstName[0]+LastName[0];
   return firstInitial
  });
  
  console.log("10. The initial of the inventors names are", fullNameInitial)
  ...
  let inventorsFirstEvery = inventors.every(name =>{
    let eachName=name.split(" ")[0]
    eachName.length > 4 })
  console.log("20. Is it true that every inventor has first namelonger than 4 characters ?", inventorsFirstEvery)
  ...
  console.log("25. The number not divisible by 7 are ", findNumberNotDivisible7)
  ...
  console.log("Your 14th number should be ", fib[fib.length-1])